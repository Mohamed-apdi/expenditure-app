...
export const LANGUAGES = {
  en: {
    ...
    balanceAdjustmentDescription: "Account balance adjustment",
    jobSalary: "Salary",
    bonus: "Bonus",
    ...
    evcImportAccountsSummaryFallback: "Fallback",
    ...
    evcSelectCategory: "Select category",
    evcCategorizeTitle: "Categorize this transaction",
    evcCategorizeSubtitle: "This helps improve your reports",
    evcSuggested: "Suggested",
    evcMoreCategories: "More categories",
    evcAddNoteOptional: "+ Add note (optional)",
    evcNoteLabel: "Note",
    evcNotePlaceholder: "Add a note...",
    evcUsedBefore: "Used before",
    evcTransactionsNeedCategory: "{{count}} transactions need category",
    evcNeedCategoryLine2: "transactions need a category",
    evcSelectMultiple: "Select multiple",
    evcApplyToSelected: "Apply to selected",
    uncategorizedTransactions: "Uncategorized transactions",
    transactionUncategorized: "Uncategorized",
    transactionNeedsCategory: "Needs category",
    transactionTapToCategorize: "Tap to categorize",
    transactionSentViaEvc: "Sent via EVC",
    transactionReceivedViaEvc: "Received via EVC",
    ...
    budgetVsActualSpending: "Budget vs Actual Spending",
    ...
    reportSavedToDocuments: "Report Saved to Documents",
    ...
    exportAccountReport: "Export Account Report",
    exportBudgetReport: "Export Budget Report",
    exportGoalsReport: "Export Goals Report",
    ...
    loadingGoalData: "Loading goals data...",
    ...
    atRisk: "At Risk",
    completed: "Completed",
    toReachAllGoals: "to reach all goals",
    ...
    getSpendingInsights: "Get insights into your spending",
    ...
    welcomeToFinancialJourney: "Welcome to your financial journey!",
    failedToCreateAccount: "Failed to create account",
    pleaseTryAgain: "Please try again",
    permissionToAccessCamera: "Permission to access camera roll is required",
  },
  ...
  so: {
    ...
    darkMode: "Dark Mode",
    lightMode: "Light Mode",
    manageAccounts: "Maamul Akoonada",
    trackExpenses: "La soco Kharashka",
    ...
    error: "Error",
    missingCredentials: "Emailka ama Furaha Sirta waxbaa ka qaldan",
    success: "Guul",
    ...
    profileInfoEncrypted:
      "Macluumaadka profile-kaaga waa la xifdiyay oo la kaydiyay si amni ah. Ma sahalano macluumaadkaaga shakhsi kale inuu maamulo.",
    ...
    discardChanges: "Ka labo Isbedelada",
    unsavedChangesMessage:
      "Waxaad haysataa isbedelada aan la kaydin. Ma hubtaa inaad aad ka noqon doonto?",
    keepEditing: "Siiwad wax beddel ka",
    discard: "Ka labo",
    ...
    refreshing: "refreshing...",
    refresh: "refresh",
    refreshingTransactions: "refreshing dhaqdhaqaaqa...",
    noTransactionsYet: "Ma xusuusan dhaqdhaqaaqa",
    ...
    BalanceAdjustment: "Hagaajinta Dheellitirka",
    balanceAdjustmentDescription: "Hagaajinta dheellitirka koontada",
    ...
    subscriptionReports: "Warbixinada Rukunka",
    budgetReports: "Warbixinada Miisaaniyadda",
    goalReports: "Warbixinada Hadafyada",
    ...
    // Additional report translations
    subscriptionReport: "Warbixinada Rukumada",
    budgetReport: "Warbixinada Miisaaniyada",
    goalsReport: "Warbixinada Hadafyaadka",
    accountReport: "Warbixinada Akoonaadka",
    transactionReport: "Warbixinada Dhaqdhaqaaqa",
    totalSubscriptions: "Wadarta Rukumada",
    monthlyCost: "Lacagta Bishii",
    yearlyCost: "Lacagta Sanadka",
    totalBudget: "Wadarta Miisaaniyada",
    totalSpent: "Wadarta La Bixiyay",
    totalRemaining: "Wadarta Ka Hadhay",
    overallProgress: "Horumarka Guud",
    budgetVsActualSpending: "Miisaaniyada vs Kharashaadka Runta ah",
    unbudgetedSpending: "Kharashaadka aan Miisaaniyada lahayn",
    goalsProgress: "Horumarka Hadafyaadka",
    financialGoalsProgress: "Horumarka Hadafyaadka Lacagta",
    totalGoals: "Wadarta Hadafyaadka",
    completedGoals: "Hadafyaadka La Dhammeeyay",
    totalTarget: "Wadarta Hadafka",
    totalSaved: "Wadarta La Kaydiyay",
    pdfGenerated: "PDF-ka waa la sameeyay",
    csvGenerated: "CSV-ka waa la sameeyay",
    reportSavedToDocuments: "Warbixinada waa la kaydiyay goobta Faylka",
    noTransactionsFound: "Dhaqdhaqaaq lama helin",
    noAccountData: "Xogta Akoonka ma jirto",
    noBudgetsFound: "Miisaaniyada lama helin",
    noGoalsSet: "Hadafyaadka lama dejin",
    noSubscriptionsFound: "Rukumo lama helin",
    exportReport: "Soo saar Warbixinada",
    exportAccountReport: "Soo saar Warbixinada Akoonaadka",
    exportBudgetReport: "Soo saar Warbixinada Miisaaniyada",
    exportGoalsReport: "Soo saar Warbixinada Hadafyaadka",
    ...
    loadingGoalData: "Xogta hadafyaadka la soo dejinayaa...",
    loadingSubscriptionData: "Xogta rukumada la soo dejinayaa...",
    allAccounts: "Dhammaan Akoonaadka",
    generated: "La sameeyay",
    monthlyEquivalent: "U dhiganta Bishii",
    nextBilling: "Lacag Bixinta Xigta",
    // goalName: "Magaca Hadafka",
    // targetAmount: "Lacagta Hadafka",
    // currentAmount: "Lacagta Hadda",
    daysRemaining: "Maalin Hadhay",
    // targetDate: "Taariikhda Hadafka",
    overdue: "Ka Dhaaftay",
    failedToSharePdf: "Wadaagida PDF-ka waa la guuldarreysatay",
    failedToShareCsv: "Wadaagida CSV-ka waa la guuldarreysatay",
    loanRepayment: "Lacag Bixinta Amaaha",
    overBudget: "Ka Baxay Miisaaniyadda",
    nearLimit: "U Dhow Xadka",
    ...
    toReachAllGoals: "si aad u gaadho hadafyada oo dhan",
    goalCompleted: "Hadafka la gaadhay!",
    goalsCompleted: "Hadafyada la gaadhay!",
    ...
    loansGiven: "Amaaho La Siiyay",
    loansTaken: "Amaaho La Qaatay",
    outstanding: "la soo celin",
    overdueLoans: "Amaaho Ka Dhaaftay",
    requiresAttention: "Waxay u baahan tahay feejignaankaaga",
    ...
    incomeVsExpenses: "Dakhli vs Kharashaad",
    spendingTrend: "Dhaqdhaqaaqa Kharashaadka",
    transactionStats: "Xogta Dhaqdhaqaaqa",
    ...
    getSpendingInsights: "Hel fahanka kharashaadkaaga",
    ...
    accountCreatedSuccessfully: "Akoonka si guul leh ayaa loo abuuray!",
