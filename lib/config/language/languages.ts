...
export const LANGUAGES = {
  ...
  so: {
    ...
    vacation: "Fasax / Dalxiis",
    children: "Carruurta",
    gymAndSports: "Jimicsi iyo Ciyaaro",
    electronics: "Koronto & Qalabka Elektarooniga",
    furniture: "Qalabka Guriga",
    repairs: "Dayactir",
    taxes: "Canshuur",
    ...
    business: "Ganacsi",
    rentIncome: "Dakhliga Kirada",
    sales: "Iibin",
    awards: "Abaal-marin",
    freelance: "Shaqo Madaxbannaan",
    giftsReceived: "Hadiyad La Helay",
