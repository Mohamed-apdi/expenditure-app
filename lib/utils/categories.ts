...
/** Expense colors: spread across hues so pies aren’t mostly blue/cyan (one “tech” blue only). */
export const getExpenseCategories = (t: any): Category[] => [
  ...
  { id: "shopping", name: t.shopping, icon: ShoppingBag, color: "#ec4899" },
  { id: "education", name: t.learning, icon: GraduationCap, color: "#65a30d" },
  { id: "personal_care", name: t.personalCare, icon: Smile, color: "#f472b6" },
  { id: "insurance", name: t.insurance, icon: Shield, color: "#0f766e" },
  { id: "debt", name: t.loans, icon: CreditCard, color: "#b91c1c" },
  { id: "gifts", name: t.gifts, icon: Gift, color: "#c026d3" },
  { id: "charity", name: t.donations, icon: HandHeart, color: "#22c55e" },
  { id: "travel", name: t.vacation, icon: Luggage, color: "#fb923c" },
  { id: "pets", name: t.pets, icon: PawPrint, color: "#f59e0b" },
  { id: "kids", name: t.children, icon: Baby, color: "#db2777" },
  { id: "family", name: t.family, icon: Users, color: "#4f46e5" },
  { id: "subscriptions", name: t.subscriptions, icon: Repeat, color: "#e879f9" },
  { id: "fitness", name: t.gymAndSports, icon: Dumbbell, color: "#166534" },
  /** Sole saturated blue for “tech” — keeps charts from turning all blue */
  { id: "electronics", name: t.electronics, icon: Smartphone, color: "#2563eb" },
  { id: "furniture", name: t.furniture, icon: Sofa, color: "#a16207" },
  { id: "repairs", name: t.repairs, icon: Wrench, color: "#475569" },
  { id: "taxes", name: t.taxes, icon: Receipt, color: "#422006" },
  { id: "others", name: t.others, icon: Tag, color: "#64748b" },
];

/** Income colors: same idea — varied hues, minimal duplicate blues */
export const getIncomeCategories = (t: any): Category[] => [
  { id: "salary", name: t.jobSalary, icon: DollarSign, color: "#059669" },
  { id: "bonus", name: t.bonus, icon: Zap, color: "#f59e0b" },
  { id: "part_time", name: t.partTimeWork, icon: Clock, color: "#ea580c" },
  { id: "business", name: t.business, icon: Briefcase, color: "#7c3aed" },
  { id: "investments", name: t.investments, icon: TrendingUp, color: "#1d4ed8" },
  { id: "interest", name: t.bankInterest, icon: Percent, color: "#14b8a6" },
  { id: "rental", name: t.rentIncome, icon: Home, color: "#84cc16" },
  { id: "sales", name: t.sales, icon: ShoppingBag, color: "#78716c" },
  { id: "gambling", name: t.gambling, icon: Dice5, color: "#e11d48" },
  { id: "awards", name: t.awards, icon: Award, color: "#ec4899" },
  { id: "refunds", name: t.refunds, icon: RefreshCw, color: "#06b6d4" },
  { id: "freelance", name: t.freelance, icon: Laptop, color: "#d97706" },
  { id: "royalties", name: t.royalties, icon: Book, color: "#65a30d" },
  { id: "grants", name: t.grants, icon: HandCoins, color: "#4d7c0f" },
  { id: "gifts", name: t.giftsReceived, icon: Gift, color: "#c026d3" },
  { id: "pension", name: t.pension, icon: User, color: "#57534e" },
];
