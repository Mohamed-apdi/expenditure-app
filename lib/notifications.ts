...
export type NotificationType = 'budget' | 'subscription' | 'transfer' | 'expense' | 'income' | 'account' | 'system';
 ...
 */
export async function deleteOldNotifications(userId: string, daysOld = 30): Promise<boolean> {
  try {
