...
function buildPayload(table: SyncEntity, row: any, userId: string): any {
  ...
  const tableColumns: Record<SyncEntity, string[]> = {
    ...
    expenses: ["id", "user_id", "account_id", "amount", "category", "description", "date", "is_recurring", "recurrence_interval", "is_essential", "created_at", "updated_at", "receipt_url", "entry_type", "evc_kind", "evc_counterparty_phone"],
    transactions: ["id", "user_id", "account_id", "amount", "description", "date", "category", "is_recurring", "recurrence_interval", "type", "created_at", "updated_at", "evc_kind", "evc_counterparty_phone", "source_expense_id"],
