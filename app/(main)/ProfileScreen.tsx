...
import { 
  Edit3, Camera, Clock, Calendar, Target, UserCheck, User, Phone, 
  AtSign, Mail, Key, Smartphone, Shield, AlertTriangle, Trash2, 
  LogOut, Check, X, ChevronRight, Lock 
    ...
    <SafeAreaView className="flex-1 bg-slate-900">
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <View className="flex-row justify-between items-center px-6 py-5">
          ...
          <TouchableOpacity 
            className="p-2"
            onPress={() => router.push({ pathname: "../(profile)/UpdateProfileScreen" as any, params: { userProfile: JSON.stringify(userProfile) }})}
          >
        ...
        <View className="items-center px-6 pb-8">
          ...
          <View className="items-center">
            <Text className="text-white text-2xl font-bold mb-1">{userProfile.fullName}</Text>
            <Text className="text-emerald-500 text-base mb-2">@{userProfile.username}</Text>
        ...
        <View className="flex-row px-6 mb-8 gap-3">
          <View className="flex-1 bg-slate-800 rounded-xl p-4 items-center border border-slate-700">
            ...
            <Text className="text-white text-xl font-bold mt-2 mb-1">{userProfile.totalPredictions}</Text>
            <Text className="text-slate-400 text-xs">Predictions</Text>
          </View>
          <View className="flex-1 bg-slate-800 rounded-xl p-4 items-center border border-slate-700">
            <Target size={20} color="#3b82f6" />
            <Text className="text-white text-xl font-bold mt-2 mb-1">{userProfile.avgAccuracy}%</Text>
        ...
        <View className="px-6 mb-8">
          <Text className="text-white text-lg font-bold mb-4">Contact Information</Text>
          ...
          <View className="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden">
            ...
            <View className="flex-row items-center p-4">
              ...
              <View className="ml-4 flex-1">
                ...
                <Text className="text-white text-base font-medium">{userProfile.fullName}</Text>
              </View>
              <TouchableOpacity 
                className="p-2"
                onPress={() => router.push({ 
            ...
            <View className="flex-row items-center p-4">
              ...
              <View className="ml-4 flex-1">
                <Text className="text-slate-400 text-xs mb-1">Phone Number</Text>
                <Text className="text-white text-base font-medium">{userProfile.phone}</Text>
              </View>
              <TouchableOpacity 
                className="p-2"
                onPress={() => router.push({ 
            ...
            <View className="flex-row items-center p-4">
              ...
              <View className="ml-4 flex-1">
                ...
                <Text className="text-white text-base font-medium">@{userProfile.username}</Text>
              </View>
              <TouchableOpacity 
                className="p-2"
                onPress={() => router.push({ 
            ...
            <View className="flex-row items-center p-4">
              ...
              <View className="ml-4 flex-1">
                ...
                <Text className="text-white text-base font-medium">{userProfile.email}</Text>
              </View>
              <TouchableOpacity 
                className="p-2"
                onPress={() => router.push({ 
        ...
        <View className="px-6 mb-8">
          ...
          >
            ...
            <View className="flex-1">
              <Text className="text-white text-base font-semibold mb-1">Change Password</Text>
          ...
          <TouchableOpacity className="flex-row items-center bg-slate-800 rounded-xl p-4 mb-3 border border-slate-700">
            ...
            <View className="flex-1">
              <Text className="text-white text-base font-semibold mb-1">Two-Factor Authentication</Text>
          ...
          <TouchableOpacity className="flex-row items-center bg-slate-800 rounded-xl p-4 border border-slate-700">
            ...
            <View className="flex-1">
              <Text className="text-white text-base font-semibold mb-1">Privacy Settings</Text>
              <Text className="text-slate-400 text-sm">Manage your data and privacy</Text>
            </View>
            <ChevronRight size={20} color="#64748b" />
          </TouchableOpacity>
        </View>
        ...
        {/* Danger Zone */}
        <View className="px-6 mb-8">
          <Text className="text-red-500 text-lg font-bold mb-4">Danger Zone</Text>

          <View className="bg-slate-800 rounded-xl p-5 border border-red-500">
            <View className="mb-4">
              <View className="flex-row items-center mb-2">
                <AlertTriangle size={20} color="#ef4444" />
                <Text className="text-red-500 text-base font-bold ml-2">Delete Account</Text>
              </View>
            ...
            >
              ...
              <Text className="text-white text-sm font-bold ml-2">Delete Account</Text>
            </TouchableOpacity>
          </View>
        </View>
          ...
          <ScrollView className="flex-1 px-6">
            <View className="py-6">
              ...
              <View className="bg-slate-800 rounded-lg p-4 border border-slate-700 mb-6">
                <Text className="text-slate-400 text-xs font-medium mb-2">Password Requirements:</Text>
                ...
                <View className="flex-row items-center mb-1">
                  ...
                  />
                  <Text className="text-slate-200 text-xs ml-2">At least 8 characters</Text>
                </View>
                ...
                <View className="flex-row items-center mb-1">
                  ...
                  />
                  <Text className="text-slate-200 text-xs ml-2">One uppercase letter</Text>
                </View>
                ...
                <View className="flex-row items-center">
                  ...
                  />
                  <Text className="text-slate-200 text-xs ml-2">One number</Text>
                </View>
              </View>
