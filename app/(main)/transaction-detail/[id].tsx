        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              const table = transaction?.type === 'expense' ? 'expenses' : 'transactions';
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        ...
        >
          <View style={{ alignItems: 'center' }}>
            ...
            <Text style={{ color: theme.textSecondary, fontSize: 14, marginBottom: 8 }}>
              {transaction.type === 'expense' ? 'Amount Spent' : 
               transaction.type === 'income' ? 'Amount Received' : 'Amount Transferred'}
            </Text>
            ...
            >
              ...
              <Text style={{ color: theme.success, marginLeft: 6, fontSize: 12, fontWeight: '600' }}>
                {transaction.type.charAt(0).toUpperCase() + transaction.type.slice(1)} Completed
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={{ paddingHorizontal: 20 }}>
            ...
            {transaction.description && (
              <View style={{ marginBottom: 16 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
                  ...
                  <Text style={{ color: theme.textSecondary, fontSize: 12, marginLeft: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>
                    Description
                  </Text>
                  <TouchableOpacity 
                    style={{ marginLeft: 'auto' }}
                    onPress={() => copyToClipboard(transaction.description || '', 'Description')}
                  >
          ...
          {/* Additional Details */}
          {(transaction.payment_method || transaction.is_recurring || transaction.location || transaction.notes) && (
            <View
              style={{
                backgroundColor: theme.cardBackground,
                borderRadius: 12,
          ...
          >
            ...
            <View style={{ marginBottom: 16 }}>
              ...
              <Text style={{ color: theme.text, fontSize: 16 }}>
                {format(new Date(transaction.created_at), "EEEE, MMMM d, yyyy 'at' h:mm a")}
              </Text>
              <Text style={{ color: theme.textSecondary, fontSize: 14, marginTop: 4 }}>
            ...
            <View>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                >
                  <Text style={{ color: transactionColor, fontSize: 12, fontWeight: '600', textTransform: 'uppercase' }}>
                    {transaction.type}
                  </Text>
                </View>
              </View>
