      ...
      <TouchableOpacity
        style={{
          backgroundColor: isSelected ? theme.primary + '20' : 
                          item.is_read ? theme.cardBackground : theme.background,
          borderRadius: 12,
          padding: 16,
          marginHorizontal: 16,
          marginVertical: 4,
          ...
          borderColor: isSelected ? theme.primary : 
                      item.is_read ? theme.border : theme.primary + '30',
          borderLeftWidth: 4,
          borderLeftColor: priorityColor,
        }}
        onPress={() => isSelectionMode ? toggleNotificationSelection(item.id) : handleNotificationPress(item)}
        onLongPress={() => {
          if (!isSelectionMode) {
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      >
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          ...
          <Text style={{ color: theme.text, fontSize: 20, fontWeight: '700', marginLeft: 12 }}>
            Notifications
          </Text>
          {unreadCount > 0 && (
            <View
