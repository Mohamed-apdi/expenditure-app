...
export default function BasicInputsScreen() {
  ...
  const [localData, setLocalData] = useState<InputData>(
    params.inputData
      ? JSON.parse(params.inputData as string)
      : {
          exp_food: 500,
          exp_nfnd: 300,
          exp_rent: 0,
        ...
        <View className="bg-slate-800 mx-6 mb-4 p-5 rounded-xl border border-slate-700">
          ...
          <View className="px-2">
            <Slider
              ...
              onValueChange={(value) =>
                updateValue("exp_food", Math.round(value))
              }
        ...
        <View className="bg-slate-800 mx-6 mb-4 p-5 rounded-xl border border-slate-700">
          ...
          <View className="px-2">
            <Slider
              ...
              onValueChange={(value) =>
                updateValue("exp_nfnd", Math.round(value))
              }
        ...
        <View className="bg-slate-800 mx-6 mb-4 p-5 rounded-xl border border-slate-700">
          ...
          <View className="flex-row items-center justify-center gap-5">
            <TouchableOpacity
              ...
              onPress={() =>
                updateValue("hhsize", Math.max(1, localData.hhsize - 1))
              }
            >
            ...
            <TouchableOpacity
              className="w-11 h-11 rounded-full bg-slate-700 justify-center items-center"
              onPress={() =>
                updateValue("hhsize", Math.min(20, localData.hhsize + 1))
              }
            >
            ...
            {regions.map((region) => (
              <TouchableOpacity
                ...
                className={`flex-1 py-4 px-5 rounded-lg items-center ${
                  localData.region_n === region.value
                    ? "bg-emerald-500"
                    : "bg-slate-700"
                }`}
            ...
            <View className="flex-row justify-between items-center">
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  updateValue(
                    "hh_electricity",
                    localData.hh_electricity === 1 ? 0 : 1
                  )
                }
              >
                <View
